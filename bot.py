...
TEXTS = {
    "start": (
        ...
        "в течение 24 часов.\n\n"
        "📚 Также подписывайся на наш канал!: "
        "[Long Coffe](https://t.me/LongCoffeeLove)"
    ...
    "about_psychologist": (
        ...
        "📚 Полезные материалы в канале: "
        "[Long Coffee](https://t.me/LongCoffeeLove)"
    ),
    "write_problem": (
        "✍️ *Написать о проблеме*\n\n"
        "Опишите вашу ситуацию, отправьте видео-кружок или голосовое сообщение, "
        "и оно будет анонимно переправлено психологу.\n\n"
        "💡 *Совет:* Будьте максимально подробны в описании - это поможет "
        "психологу лучше понять вашу ситуацию.\n\n"
        "📚 Пока ждете ответ, почитайте полезные материалы в нашем канале: "
        "[Long Coffee](https://t.me/LongCoffeeLove)"
    ),
    "message_sent": (
        "✅ Ваше сообщение было отправлено психологу!\n\n"
        "⏳ Ожидайте ответ в течение 24 часов.\n"
        "📩 Вы получите уведомление, когда психолог ответит.\n\n"
        "📚 А пока можете почитать полезные материалы в нашем канале: "
        "[Long Coffee](https://t.me/LongCoffeeLove)"
    ),
    "no_responses": (
        "📭 Пока нет новых ответов от психолога.\n\n"
        "⏳ Если вы отправили сообщение, ответ придет в течение 24 часов.\n\n"
        "📚 Почитайте полезные материалы в нашем канале: "
        "[Long Coffee](https://t.me/LongCoffeeLove)" 
    ),
